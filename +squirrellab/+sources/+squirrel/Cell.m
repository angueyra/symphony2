        ...
        function obj = Cell()
            ...
            obj.addProperty('type', 'unknown', ...
                'type', PropertyType('char', 'row', containers.Map( ...
                    ...
                    {{}, ...
                    {'ON-alpha', 'ON-transient', 'OFF-transient', 'OFF-sustained', 'ON/OFF DS', 'ON DS', 'W3/local edge detector','ipRGC'}, ...
            ...
            obj.addAllowableParentType('squirellab.sources.squirrel.Preparation');
        end
